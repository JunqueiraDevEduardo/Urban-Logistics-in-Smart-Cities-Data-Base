...
% --- Comando seguro para iniciar os anexos sem capítulos ---
\makeatletter
\newcommand{\beginannexes}{%
  \cleardoublepage
  \@mainmatterfalse            % desativa lógica de capítulos
  \setcounter{secnumdepth}{-1} % sem numeração automática
  \addchap{Anexos}             % cria a página "Anexos" e mete no Índice
}
\makeatother
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% settings
