...
\begin{itemize}
    ...
    \item A necessidade de setores públicos e privados trabalharem em conjunto para alcançar soluções eficazes \cite{article};
...
A gestão de energia é um dos fatores importante para cidades sustentáveis, como por exemplo o aluguer de painéis solares para edifícios residênciais e comerciais, reduz o consumo de energia elétrica da rede pública, e aumenta a energia renovável que é produzida localmente \cite{EnergiaSolar}.
...
Para garantir estes exemplos, de sustentabilidade de muitos outros, de acordo com o Artigo I, as cidades urbanas devem ter 6 domínios nomeados de \textit{"Smart"} \cite{article}:
\begin{itemize}
\item \textbf{\textit{Smart economy}}:  Consiste em agrupar a competividade económica que as empresas possuem melhorando a logística de mercados globais entre taxas de produtos ou serviços, entre outros.
...
\item \textbf{\textit{Smart mobility}}: Sincronização dos vários meios de transporte públicos tais como metros, comboios, autocarros, bicicletas entre outros e adoção de transportes elétricos e inteligentes nomeados por \gls{va} \cite{CLEOPHAS2019801}.
...
\textbf{De notar que:} a eficácia da \gls{ai} na logística depende não apenas da tecnologia, mas também da integração com políticas públicas e da confiança das empresas e clientes finais.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
A Alemanha propôs um sistema de transporte inovador de \textit{last-mile}.
...
As principais vantagens deste sistema em relação ao convencional por entregas de \textit{Van} carrinha de transporte convencional são: redução de emissões de \gls{co2}, redução de \verb|km/dia| percorrido, e melhor coordenação entre o consumidor final e as mercadorias\cite{article2}.
...
A \gls{fig} abaixo \ref{fig:egc_conceito_logistico_transporte} ilustra este conceito logístico de transporte na cidade urbana consoante fatores de deslocamentos associados a distâncias mais convenientes para existir uma otimização de rotas mais curtas.
\begin{figure}[H]
    \centering
...
\textbf{De notar que:} este artigo V segue o mesmo conceito do artigo IV.
...
\begin{itemize}
    ...
    \item \textbf{4-Localizar os pontos de armazenamento:} Considerando o meio de transporte bicicleta os pontos de armazenamento devem estar localizados em áreas de fácil acesso no centro de cidades num máximo de tempo de 15 minutos, como por exemplo em grandes centros comerciais ou em centros de condomínio residênciais.
\end{itemize}

A opinião dos \textit{stakeholders} foi recolhida através de entrevistas e questionários aplicados a diferentes autarcas envolvidos no Município urbano.
...
O Município do Porto em conjunto com o  estado portugues,  vai investir 351,98 milhões de \gls{eur}, através do \gls{prr}, para promover a mobilidade urbana sustentável, com o objetivo de reduzir as emissões de gases com efeito de estufa e melhorar a qualidade do ar na cidade do Porto \cite{AMP}.
...
\begin{figure}[H]
    ...
    \caption{Serviço de mobilidade sustentável no Município de Águeda, Portugal, citado na página do mesmo: \cite{Águeda_vence_prémio_European_Green_Leaf_2026}.}
...
\end{figure}
Asim, podemos concluir que a verdadeira inteligencia de uma cidade urbana vem de um bom planeamento lógico, cooperação entre todos os \textit{stakeholders} e implementação de normas globais \cite{en15114103}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Revisto tudo!